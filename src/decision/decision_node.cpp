...
class decision {
    private:
        ...
        ros::Publisher pub_switch_state_to_path;
        ros::Subscriber sub_switched_state_to_follow;
    ...
    decision() {
        ...
        pub_switch_state_to_path = n.advertise<std_msgs::Float32>("switch_state_path", 0);
        sub_switched_state_to_follow = n.subscribe("switch_state_follow", 1, &decision::switch_stateCallback, this);
...
int main(int argc, char **argv){
    ...
    ROS_INFO("(decision_node) waiting for a /goal_to_reach salut les enfants");
